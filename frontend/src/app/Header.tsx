        ...
        <Card style={{ marginTop: 10, marginBottom: 12, padding: 0 }}>
          <Flex align="center" justify="between" gap="3" style={{ padding: '10px 14px' }}>
            <Flex align="center" gap="3">
              ...
              <Flex gap="3" display={{ initial: 'none', md: 'flex' }}>
            ...
            <Flex align="center" gap="2">
              ...
              {token && user ? (
                <>
                  <Badge color="violet" variant="soft">{displayRole}</Badge>
                  ...
                  >
                    <DropdownMenu.Root open={profileOpen} onOpenChange={setProfileOpen}>
                      ...
                      <DropdownMenu.Content
                        align="end"
                        onPointerEnter={() => setProfileOpen(true)}
                        onPointerLeave={() => setProfileOpen(false)}
                      >
                        ...
                        <DropdownMenu.Separator />
                        <DropdownMenu.Item color="red" onClick={() => void logout()}>
                          Выйти
                        </DropdownMenu.Item>
                      </DropdownMenu.Content>
                    </DropdownMenu.Root>
